...
public final class MeasurementUtils {
	...
	static {
		...
		//mapMetricBean.put("iqr", new MetricBean("iqr", "millisecond", "Interquartile Range", "SimpleMeasurementIQRMeasurement"));
		//mapMetricBean.put("maximum_rtt", new MetricBean("maximum_rtt", "millisecond", "Maximum RTT", "MaximumRoundTripDelayMeasurement"));
		//mapMetricBean.put("minimum_packet_loss", new MetricBean("minimum_packet_loss", "percent", "Minimum Packet Loss", "MinimumPacketLossMeasurement"));
		//mapMetricBean.put("out_of_order_packets", new MetricBean("out_of_order_packets", "Dimensionless", "Packets Out of Order", "OutOfOrderPacketsMeasurement"));
		//mapMetricBean.put("unpredictability", new MetricBean("unpredictability", "Dimensionless", "Unpredictability", "PingUnpredictabilityMeasurement"));
	}
